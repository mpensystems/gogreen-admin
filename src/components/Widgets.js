...
export const ProfileCardWidget = ({ profileData }) => {
  const { fullName, city, vehicleNumber, state, rid, mobile, photo } =
    profileData;
    ...
    <Card border="light" className="text-center p-0 mb-4">
      ...
      <Card.Body className="pb-5">
        <div className="user-avatar large-avatar mx-auto mt-n7 mb-1 rounded-circle">
          <ImageComponent token={token} rid={rid} fileid={photo} round={true} />
        </div>

        <Card.Title>{fullName}</Card.Title>
        <Card.Text className="text-gray mb-3">
          Vehicle No :{vehicleNumber}
        </Card.Text>
        <Card.Text className="text-gray mb-3">
          City of Operation : {city + " , " + state}
        </Card.Text>
        ...
        <div className="text-start px-4">
          ...
          <div className="row mb-2">
            ...
            <div className="col-8">
              ...
              {profileData?.city}, {profileData?.zipcode}, {profileData?.state},{" "}
