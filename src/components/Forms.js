      ...
      <Card.Body>
        ...
        <Form>
          ...
          <Row>
            ...
            <Col md={6} className="mb-3">
              <Form.Group id="firstName">
                <Form.Label>pickup address 1</Form.Label>
                <Form.Control required type="text" placeholder="Enter your first name" />
              </Form.Group>
            </Col>
            <Col md={6} className="mb-3">
          ...
          <Row>
            ...
            <Col md={6} className="mb-3">
              <Form.Group id="firstName">
                <Form.Label>pickup_zip</Form.Label>
                <Form.Control required type="text" placeholder="Enter your first name" />
              </Form.Group>
            </Col>
            <Col md={6} className="mb-3">
              <Form.Group id="lastName">
                <Form.Label>pickup_address1</Form.Label>
                <Form.Control required type="text" placeholder="Also your last name" />
              </Form.Group>
            </Col>
          </Row>
          <Row>
            ...
            <Col md={6} className="mb-3">
              <Form.Group id="lastName">
                <Form.Label>pickup_city	</Form.Label>
                <Form.Control required type="text" placeholder="Also your last name" />
              </Form.Group>
            </Col>
          </Row>
          <Row>
            ...
            <Col md={6} className="mb-3">
              <Form.Group id="firstName">
                <Form.Label>pickup_state	</Form.Label>
                <Form.Control required type="text" placeholder="Enter your first name" />
              </Form.Group>
            </Col>
            <Col md={6} className="mb-3">
              <Form.Group id="lastName">
                <Form.Label>pickup_district	</Form.Label>
                <Form.Control required type="text" placeholder="Also your last name" />
              </Form.Group>
            </Col>
          </Row>
          ...
          <h5 className="my-4">pickup_city</h5>
          <Row>
